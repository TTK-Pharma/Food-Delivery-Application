...
class Filter extends React.Component{
    ...
    handlePrize = (lcost, hcost) => {
        const { mealtype, location, page, cuisine,sort } = this.state;
            ...
            <div>
                ...
                <div className="container mb-5">
                    ...
                    <div className="filter-box mt-2 pb-4">
                        ...
                        <input type="radio" id="500" name="costfortwo" value="Less than 500" onClick={() => {this.handlePrize(0, 500)}}/> <label for="500" className="filter-content">Less than `500</label> <br />
                        <input type="radio" id="1000" name="costfortwo" value="500 to 1000" onClick={() => {this.handlePrize(500, 1000)}}/> <label for="1000" className="filter-content">` 500 to ` 1000</label> <br />
                        <input type="radio" id="1500" name="costfortwo" value="1000 to 1500" onClick={() => {this.handlePrize(1000, 1500)}}/> <label for="1500" className="filter-content">` 1000 to ` 1500</label> <br />
                        <input type="radio" id="2000" name="costfortwo" value="1500 to 2000" onClick={() => {this.handlePrize(1500, 2000)}}/> <label for="2000" className="filter-content">` 1500 to ` 2000</label> <br />
                        <input type="radio" id="2000+" name="costfortwo" value="2000+" onClick={() => {this.handlePrize(2000, 2500)}}/> <label for="2000+" className="filter-content">` 2000+</label> <br />
                                ...
                                <div className="results" onClick={() => this.handleDetailsPage(item._id)}>
                                    <div className="d-flex">
                                        <div className="lt-box">
                                            <img src={item.thumb} className="img-fluid img-qs" />
                                        </div>
